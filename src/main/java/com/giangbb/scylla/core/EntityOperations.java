...
import com.giangbb.scylla.core.cql.util.StatementBuilder;
...
public class EntityOperations {
	...
	public EntityOperations(ScyllaConverter converter) {
		this(converter.getMappingContext(), converter.getCustomConversions(), converter.getProjectionFactory());
	}

	EntityOperations(MappingContext<? extends ScyllaPersistentEntity<?>, ScyllaPersistentProperty> context,
	 ...
	 * @see com.giangbb.scylla.core.mapping.ScyllaMappingContext
	 */
	ScyllaPersistentEntity<?> getRequiredPersistentEntity(Class<?> entityClass) {
	...
	protected MappingContext<? extends ScyllaPersistentEntity<?>, ScyllaPersistentProperty> getMappingContext() {
	...
	interface AdaptibleEntity<T> extends Entity<T> {
		...
		/**
		 * Returns the {@link ScyllaPersistentEntity}.
		 *
		 * @return the {@link ScyllaPersistentEntity}.
		 */
		ScyllaPersistentEntity<?> getPersistentEntity();
	...
	private static class MappedEntity<T> implements Entity<T> {
		...
		protected MappedEntity(ScyllaPersistentEntity<?> entity, PersistentPropertyAccessor<T> propertyAccessor) {
			this.entity = entity;
			this.propertyAccessor = propertyAccessor;
		}

		private static <T> MappedEntity<T> of(T bean,
				MappingContext<? extends ScyllaPersistentEntity<?>, ScyllaPersistentProperty> context) {

			ScyllaPersistentEntity<?> entity = context.getRequiredPersistentEntity(bean.getClass());
	...
	private static class AdaptibleMappedEntity<T> extends MappedEntity<T> implements AdaptibleEntity<T> {
		...
		private static <T> AdaptibleEntity<T> of(T bean,
			...
			ScyllaPersistentEntity<?> entity = mappingContext.getRequiredPersistentEntity(bean.getClass());
		...
		private AdaptibleMappedEntity(ScyllaPersistentEntity<?> entity, ConvertingPropertyAccessor<T> propertyAccessor) {
		...
		public T initializeVersionProperty() {
			...
			if (this.entity.hasVersionProperty()) {
				...
				ScyllaPersistentProperty versionProperty = this.entity.getRequiredVersionProperty();
		...
		@Override
		public ScyllaPersistentEntity<?> getPersistentEntity() {
			return this.entity;
		}
