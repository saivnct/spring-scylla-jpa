...
/**
 * Interface to access column type information. The {@link ScyllaColumnType} subtype exposes Scylla-specific
...
public interface ColumnType {
	 ...
	 * @return
	 */
	static ScyllaColumnType create(Class<?> type, DataType dataType) {
		return new DefaultScyllaColumnType(TypeInformation.of(type), dataType);
	}
	...
	static ColumnType listOf(ColumnType componentType) {
		...
		if (componentType instanceof ScyllaColumnType) {
			return listOf((ScyllaColumnType) componentType);
		}
	...
	/**
	 * Creates a List {@link ColumnType} given its {@link ScyllaColumnType component type}.
	 *
	 * @param componentType must not be {@literal null}.
	 * @return
	 */
	static ScyllaColumnType listOf(ScyllaColumnType componentType) {
	 ...
	 * @return
	 */
	static ScyllaColumnType listOf(ScyllaColumnType componentType, boolean frozen) {
		return new DefaultScyllaColumnType(TypeInformation.LIST,
	...
	static ColumnType setOf(ColumnType componentType) {
		...
		if (componentType instanceof ScyllaColumnType) {
			return setOf((ScyllaColumnType) componentType);
		}
	...
	/**
	 * Creates a Set {@link ColumnType} given its {@link ScyllaColumnType component type}.
	 *
	 * @param componentType must not be {@literal null}.
	 * @return
	 */
	static ScyllaColumnType setOf(ScyllaColumnType componentType) {
	 ...
	 * @return
	 */
	static ScyllaColumnType setOf(ScyllaColumnType componentType, boolean frozen) {
		return new DefaultScyllaColumnType(TypeInformation.SET,
	...
	/**
	 * Creates a Map {@link ScyllaColumnType} given its {@link ScyllaColumnType key and value types}.
	 *
	 * @param keyType must not be {@literal null}.
	 * @param valueType must not be {@literal null}.
	 * @return
	 */
	static ScyllaColumnType mapOf(ScyllaColumnType keyType, ScyllaColumnType valueType) {
	 ...
	 * @return
	 */
	static ScyllaColumnType mapOf(ScyllaColumnType keyType, ScyllaColumnType valueType, boolean frozen) {
		return new DefaultScyllaColumnType(TypeInformation.MAP,
				() -> DataTypes.mapOf(keyType.getDataType(), valueType.getDataType(), frozen), keyType, valueType);
	}

	/**
	 * Creates a UDT {@link ScyllaColumnType} given its {@link UserDefinedType Scylla type}.
	 *
	 * @param dataType must not be {@literal null}.
	 * @return
	 */
	static ScyllaColumnType udtOf(UserDefinedType dataType) {
		return new DefaultScyllaColumnType(UdtValue.class, dataType);
	}

	/**
	 * Creates a Tuple {@link ScyllaColumnType} given its {@link TupleType Scylla type}.
	 *
	 * @param dataType must not be {@literal null}.
	 * @return
	 */
	static ScyllaColumnType tupleOf(TupleType dataType) {
		return new DefaultScyllaColumnType(TupleValue.class, dataType);
	}
