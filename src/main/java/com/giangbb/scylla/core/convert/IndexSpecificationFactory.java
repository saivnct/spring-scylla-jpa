...
import com.giangbb.scylla.core.mapping.SASI;
import com.giangbb.scylla.core.mapping.SASI.NonTokenizingAnalyzed;
import com.giangbb.scylla.core.mapping.SASI.Normalization;
import com.giangbb.scylla.core.mapping.SASI.StandardAnalyzed;
...
/**
 * Factory to create {@link com.giangbb.scylla.core.cql.keyspace.CreateIndexSpecification} based on
 * index-annotated {@link ScyllaPersistentProperty properties}.
 *
 * @author Giangbb
 * @see Indexed
 * @see SASI
...
class IndexSpecificationFactory {
	...
	/**
	 * Create a {@link List} of {@link CreateIndexSpecification} for a {@link ScyllaPersistentProperty}. The resulting
	 ...
	 */
	static List<CreateIndexSpecification> createIndexSpecifications(ScyllaPersistentProperty property) {
