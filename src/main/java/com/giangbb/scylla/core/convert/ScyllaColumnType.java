...
/**
 * Descriptor for a Scylla column type exposing a {@link DataType}.
 *
 * @author Giangbb
 */
public interface ScyllaColumnType extends ColumnType {

	/**
	 * Returns the {@link DataType} associated with this column type.
	 *
	 * @return
	 * @throws org.springframework.data.mapping.MappingException if the column cannot be mapped onto a Scylla type.
	 */
