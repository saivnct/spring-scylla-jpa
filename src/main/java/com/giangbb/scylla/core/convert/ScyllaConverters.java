...
import com.giangbb.scylla.core.cql.converter.RowToListConverter;
import com.giangbb.scylla.core.cql.converter.RowToMapConverter;
...
/**
 * Wrapper class to contain useful converters for the usage with Scylla.
 *
 * @author Giangbb
 */
abstract class ScyllaConverters {

	/**
	 * Private constructor to prevent instantiation.
	 */
	private ScyllaConverters() {}
	...
	static Collection<Object> getConvertersToRegister() {
		...
		converters.add(RowToScyllaLocalDateConverter.INSTANCE);
	...
	/**
	 * Simple singleton to convert {@link Row}s to their Scylla {@link LocalDate} representation.
	 *
	 */
	@ReadingConverter
	public enum RowToScyllaLocalDateConverter implements Converter<Row, LocalDate> {
