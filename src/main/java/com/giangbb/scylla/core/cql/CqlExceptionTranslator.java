...
import com.giangbb.scylla.core.mapping.UnsupportedScyllaOperationException;
...
public interface CqlExceptionTranslator extends PersistenceExceptionTranslator {
	 ...
	 * subsequent cast) is considered reliable when expecting Scylla-based access to have happened.
	 *
	...
	default DataAccessException translate(@Nullable String task, @Nullable String cql, RuntimeException ex) {
		...
		return translated == null ? new UnsupportedScyllaOperationException("Cannot translate exception", ex)
				: translated;
	}
}
