...
import static com.giangbb.scylla.core.cql.keyspace.CqlStringUtils.*;
 ...
 * the API to support new Scylla options as they are introduced without having to update the code immediately.
 *
 * @author Giangbb
