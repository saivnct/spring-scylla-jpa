...
/**
 * {@link ScyllaPersistentProperty} wrapper for a delegate {@link ScyllaPersistentProperty} considering
 * annotations from a constructor parameter.
 *
 * @author Giangbb
 */
class AnnotatedScyllaConstructorProperty implements ScyllaPersistentProperty {

	private final ScyllaPersistentProperty delegate;

	private final MergedAnnotation<CqlName> column;

	private final MergedAnnotation<Element> element;

	public AnnotatedScyllaConstructorProperty(ScyllaPersistentProperty delegate, MergedAnnotations annotations) {
		this.delegate = delegate;
		this.column = annotations.get(CqlName.class);
	...
	public Ordering getClusteringKeyOrdering() {
		return delegate.getClusteringKeyOrdering();
	}
