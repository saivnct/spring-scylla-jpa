...
/**
 * Annotated {@link ScyllaPersistentProperty} synthesized from a constructor parameter.
 *
 * @author Giangbb
 */
class ScyllaConstructorProperty implements ScyllaPersistentProperty {

	private final Parameter<?, ScyllaPersistentProperty> constructorParameter;

	private final String name;

	private final ScyllaPersistentEntity<?> owner;

	private final TypeInformation<?> typeInformation;

	public ScyllaConstructorProperty(Parameter<?, ScyllaPersistentProperty> constructorParameter,
                                     ScyllaPersistentEntity<?> owner) {
	...
	public CqlIdentifier getColumnName() {
		throw new IllegalStateException(String.format("Parameter %s is not annotated with @CqlName", name));
	}
	...
	@Override
	public PersistentEntity<?, ScyllaPersistentProperty> getOwner() {
		return owner;
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ScyllaConstructorProperty that)) {
			return false;
		}
