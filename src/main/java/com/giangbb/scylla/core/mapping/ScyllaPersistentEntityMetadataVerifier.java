...
/**
 * Interface for Scylla Persistent Entity Mapping Verification.
 *
 * @author Giangbb
 */
@FunctionalInterface
public interface ScyllaPersistentEntityMetadataVerifier {
	 ...
	 */
	void verify(ScyllaPersistentEntity<?> entity) throws MappingException;
}
